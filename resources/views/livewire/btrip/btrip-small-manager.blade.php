<div class="relative mx-auto  bg-gray-100 overflow-hidden border sm:rounded-lg">
    ...
    <div class="px-4 py-4 bg-white">
        {{$btrips->onEachSide(1)->links()}}
    </div>

    <div wire:loading role="status" class="absolute -translate-x-1/2 -translate-y-1/2
      top-2/4 left-1/2">
        <svg xmlns="http://www.w3.org/2000/svg" class="spinner-8 w-10 h-10 shrink-0 animate-spin fill-blue-400"
    ...
    @include('components.btrips.form')
